...
def main():
    ...
    #****** BioProcess Obj *******
    bp = BP(input_file_name='Merck_XB50',
            measured_data_sheet_name='Measured Data',
            aa_list=aa_lst)

    bp2 = BP(input_file_name='Merck_XB51',
            measured_data_sheet_name='Measured Data',
            aa_list=aa_lst)
    
    bp3 = BP(input_file_name='Merck_XB52',
            measured_data_sheet_name='Measured Data',
            aa_list=aa_lst)
    ...
    # Use Feed Conc.
    bp = cumulative_in_pro(bio_process=bp, use_feed_conc=False, use_conc_after_feed=False)
    bp2 = cumulative_in_pro(bio_process=bp2, use_feed_conc=False, use_conc_after_feed=False)
    bp3 = cumulative_in_pro(bio_process=bp3, use_feed_conc=False, use_conc_after_feed=False)
    ...
    #***** Saving *****
    cl.save_excel(file_name='CL3_BioProcess')

    #***** Plotting - Multiple Species *****
    plot_list = ['lactate', 'glucose', 'glutamine', 'asparagine', 'aspartate']
    bp.plot_profile(aa_list=plot_list, save_file_name='CL3_1')
    bp2.plot_profile(aa_list=plot_list, save_file_name='CL3_2')
    bp3.plot_profile(aa_list=plot_list, save_file_name='CL3_3')
    ...
    cl_ws6 = CellLine('CL3_Rolling_Reg_WS6')
    #***** Add each bio processs to Cell Line obj *****
    ...
    #***** Saving *****
    cl_ws6.save_excel_rolling_reg(file_name='CL3_Rolling_Reg_WS6')

    #***** Plotting - Multiple Species *****
    plot_list = ['lactate', 'glucose', 'glutamine', 'asparagine', 'aspartate']    
    # With Rolliig Poly. Reg with Saving
    bp_ws6.plot_profile(aa_list=plot_list, save_file_name='CL3_1_ws_6', rolling=True)
    bp2_ws6.plot_profile(aa_list=plot_list, save_file_name='CL3_2_ws_6', rolling=True)
    bp3_ws6.plot_profile(aa_list=plot_list, save_file_name='CL3_3_ws_6', rolling=True)
    ...
    #****** Cell Line Obj *******
    cl_ws8 = CellLine('CL3_Rolling_Reg_WS8')
    #***** Add each bio processs to Cell Line obj *****
    ...
    #***** Saving *****
    cl_ws8.save_excel_rolling_reg(file_name='CL3_Rolling_Reg_WS8')

    #***** Plotting - Multiple Species *****
    plot_list = ['lactate', 'glucose', 'glutamine', 'asparagine', 'aspartate']    
    # With Rolliig Poly. Reg with Saving
    bp_ws8.plot_profile(aa_list=plot_list, save_file_name='CL3_1_ws_8', rolling=True)
    bp2_ws8.plot_profile(aa_list=plot_list, save_file_name='CL3_2_ws_8', rolling=True)
    bp3_ws8.plot_profile(aa_list=plot_list, save_file_name='CL3_3_ws_8', rolling=True)
