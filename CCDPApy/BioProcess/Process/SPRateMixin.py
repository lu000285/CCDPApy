...
class SPRateMixin:
    '''
    Mix in class for TwoPtMixin, PolyRegMixin, RollRegMixin to calculate specific rates for Nitrogen and AA carbon.

    Methods
    -------
        sp_rate_Nit_AAC
    '''
    def sp_rate_Nit_AAC(self, method):
        '''
        ...
        if len(qAla) * 21 == total_len:
            ...
            qNitrogen_w_o_NH3_Ala = (-qAla*1 + qNh3*1 + qNitrogen).rename('qNitrogen (w/o NH3, Ala) (mmol/109 cells/hr)')
