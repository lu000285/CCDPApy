...
from CCDPApy.cell_culture_types.perfusion.in_process import CellMixin as Inprocess
from CCDPApy.cell_culture_types.perfusion.post_process.polynomial import CellMixin as Polynomial
